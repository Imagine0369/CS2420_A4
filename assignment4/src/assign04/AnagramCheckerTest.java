...
/**
 * Junit Tests for AnagramChecker class and its methods.
 * 
...
class AnagramCheckerTest {
	...
	// ------------------------- getLargestAnagramGroup(file) tests
	// start----------------------
	@Test
	void testGetLargestAnagramGroupWithNormalFile() {
		String[] expectedVals = { "allergy", "gallery", "largely" };
		assertArrayEquals(expectedVals, AnagramChecker.getLargestAnagramGroup("src/assign04/anagrams1.txt"));
	}

	@Test
	void testGetLargestAnagramGroupEmptyFile() {
		String[] emptyArr = new String[0];
		assertArrayEquals(emptyArr, AnagramChecker.getLargestAnagramGroup("src/assign04/emptytxtfile.txt"));
	}

	@Test
	void testGetLargestAnagramGroupFileNotFound() {
		String[] emptyArr = new String[0];
		assertArrayEquals(emptyArr, AnagramChecker.getLargestAnagramGroup("src/assign04/fileDNE.txt"));
	}

	@Test
	void testGetLargestAnagramGroupFileWithTextGaps() {
		String[] expectedVals = { "door", "odor" };
		assertArrayEquals(expectedVals, AnagramChecker.getLargestAnagramGroup("src/assign04/testToLines.txt"));
	}

	@Test
	void testGetLargestAnagramGroupIncompatibleFile() {
		String[] emptyArr = new String[0];
		assertArrayEquals(emptyArr, AnagramChecker.getLargestAnagramGroup("src/assign04/Anaylsis Document.docx"));
	}
